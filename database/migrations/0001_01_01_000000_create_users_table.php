...
return new class extends Migration {
    public function up(): void {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('password'); $table->enum('role',['admin','researcher','student'])->default('student');
            $table->string('affiliation')->nullable(); $table->text('bio')->nullable(); $table->rememberToken(); $table->timestamps();
        });
